...
<header class="header--main-page">
    <nav class="container container--70">
        ...
        <ul class="slogan--buttons">
            <li><a href="/admin/adminsManagement" class="btn btn--without-border">Zarządzaj administratorami</a></li>
            <li><a href="/user/usersManagement" class="btn btn--without-border">Zarządzaj użytkownikami</a></li>
            <li><a href="/institution/institutionsManagement" class="btn btn--without-border">Zarządzaj instytucjami</a>
            </li>
        </ul>
    </nav>
